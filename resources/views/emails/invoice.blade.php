                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                            <tr>
                                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                    ...
                                                    <div>
                                                        <p>If you have any queries you can always reach us </p>(<a href="mailto:smp.web254@gmail.com" style="color:#ed6e7a;text-decoration: underline;">here</a>)
                                                    </div>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="#"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('images/Facebook.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="#"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('images/Instagram.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="#"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('images/Twitter.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                                ...
                                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td width="10"></td>
                                                                        <td align="center">
                                                                            <a href="#"><img style="width:36px;border:0px;display: inline!important;" src="{{ asset('images/Pinterest.png') }}" width="36" border="0" alt="icon"></a>
                                                                        </td>
                                                                        <td width="10"></td>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td align="center">
                                                                <a href="#"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ asset('images/App-Store.png') }}" border="0" alt="icon"></a>
                                                            </td>
                                                            <td width="10" style="width: 10px;"></td>
                                                            <td align="center">
                                                                <a href="#"><img style="display:block;width:100%;max-width:117px;border:0px;" width="117" src="{{ asset('images/Google-play.png') }}" border="0" alt="icon"></a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
