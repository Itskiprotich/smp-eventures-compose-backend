                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="phone" required="required" style="width: 100%" class="form-control"
                                            id="demoSelect">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="product" style="width: 100%"  required="required" class="form-control selector"
                                                id="exampleSelect1">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$c}}</td>
                            <td><a href="/savings/view/{{$saving['phone']}}">{{$saving['firstname']}}
                                    {{$saving['lastname']}}</a></td>
                            <td>{{$saving['phone']}}</td>
                            <td>{{$saving['amount']}}</td>
                            <td>
                                @if(is_null($saving['interest']))
                                0.00
                                @else
                                {{$saving['interest']}}
                                @endif
